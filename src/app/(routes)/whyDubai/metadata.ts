...
export const metadata: Metadata = {
  title: 'Why Invest in Dubai Real Estate | Investment Guide | Evid Properties',
  ...
  openGraph: {
    title: 'Why Invest in Dubai Real Estate | Evid Properties',
    ...
    url: 'https://evidproperties.com/whyDubai',
