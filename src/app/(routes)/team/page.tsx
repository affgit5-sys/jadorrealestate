...
export const metadata: Metadata = {
  ...
  keywords: 'real estate team Dubai, property agents Dubai, luxury real estate agents, Evid Properties team, Dubai property experts',
  alternates: {
    canonical: '/team',
  },
  openGraph: {
    ...
    url: 'https://evidproperties.com/team',
