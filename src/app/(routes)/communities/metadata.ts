...
export const metadata: Metadata = {
  title: 'Luxury Communities in Dubai | Explore Dubai Neighborhoods | Evid Properties',
  ...
  openGraph: {
    title: 'Luxury Communities in Dubai | Evid Properties',
    ...
    url: 'https://evidproperties.com/communities',
